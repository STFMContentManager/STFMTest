...
namespace STFMAccounts
{
    ...
    public class PassDB
    {
        ...
        public MemberInfo RetrieveMemInfo(string PersonID)
        {
            ...
            qstring += "WHERE PhoneTypeCode IN (1,2) AND Persons.PersonID =";
            qstring += PersonID;
            ...
            RetrievedPerson.PrimaryCountry = MemInfo.Tables[0].Rows[0].Field<int>("CountryID").ToString();
