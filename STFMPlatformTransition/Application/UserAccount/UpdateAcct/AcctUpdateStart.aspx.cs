...
namespace STFMAcctUpdate
{
    public partial class STFMAcct3 : System.Web.UI.Page
    {
        ...
        {
            Session.Abandon();
            Response.Redirect("http://www.stfm.org");
        }
        ...
        public void ConfirmEdit(object sender, EventArgs e)
        {
            ...
            switch (x.ID)
            {
                case "PersonalInfoEdit":
                    {
                        Response.Redirect("AcctUpdatePersonal.aspx");
                        break;
                    }
                case "Addr1Edit":
                    {
                        Response.Redirect("AcctUpdateAddress.aspx");
                        break;
                    }
                case "Addr2Edit":
                    {
