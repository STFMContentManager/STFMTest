<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubmissionErrorMessage.aspx.cs" Inherits="RCRSubmission.SubmissionErrorMessage" %>
      ...
      <asp:TableRow>
       <asp:TableCell>
        <p style="padding-top:10px; color:Red">
         <b>
          An error has occurred while trying to submit your proposal!  This error will be reviewed shortly, we apologize for any inconvenience this may have caused.
         </b>
        </p>
