<%@ Page Language="C#" MasterPageFile="~/Timesheet.master" AutoEventWireup="true" CodeFile="ReportProfit.aspx.cs" Inherits="ReportProfit" Title="Untitled Page" %>
			...
			<asp:TableCell CssClass="FormCenter" ColumnSpan="2">
				...
				<Columns>
					...
					<asp:BoundField
						HeaderStyle-CssClass="HeaderRight"
						FooterStyle-CssClass="HeaderRight"
						HeaderText="NonProductive"
						DataField="NonProductive"
						ReadOnly="true"
						ItemStyle-Width="100px"
						ItemStyle-HorizontalAlign="right"
						FooterStyle-Font-Bold="true"
...
<!-- $Filename: D:\Inetpub\wwwroot\TimeRep\ReportProfit.aspx $   $Revision: 1.4 $ -->
</asp:Content>
